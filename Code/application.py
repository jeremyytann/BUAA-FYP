...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.vehicle_count_slider.valueChanged['int'].connect(self.vehicle_slider_count_label.setNum) 
        self.walker_count_slider.valueChanged['int'].connect(self.walker_slider_count_label.setNum) 
        self.rain_slider.valueChanged['int'].connect(self.rain_slider_label.setNum) 
        self.sun_slider.valueChanged['int'].connect(self.sun_slider_label.setNum) 
        self.fog_slider.valueChanged['int'].connect(self.fog_slider_label.setNum) 
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_15.setText(_translate("MainWindow", "事故场景生成原型系统"))
